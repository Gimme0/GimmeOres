...
public class SinglePopulator extends Populator {
     ...
     */
    public SinglePopulator(@NotNull Plugin plugin, @NotNull LoadedChunksData loadedChunksData, @NotNull Material type,
        ...
        super(plugin, loadedChunksData, type, size, triesPerChunk, minHeight, maxHeight, replaceWith, canReplace, worlds, biomes);
    }
