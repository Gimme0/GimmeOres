...
/**
 * Holds the data of chunks that have been loaded and should not be populated again.
 */
public class LoadedChunksData {
    ...
    /**
     * @return the chunk coordinates of the chunks that have been loaded
     * @param world the world to get the loaded chunks for
     */
    public Set<Point> getLoadedChunks(@NotNull World world) {
     ...
     * meaning a reset of the world's uid.dat file or this plugin's loaded-chunks.json file will generate a new seed.
     *
